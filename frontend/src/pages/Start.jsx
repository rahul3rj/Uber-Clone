    ...
    <div className='h-screen w-full flex items-center justify-center'>
        <div className='h-screen w-full flex flex-col items-center justify-start relative'>
            ...
            <div className='h-auto w-[90vw] bg-white flex flex-col items-center justify-center gap-2'>
                ...
                <button onClick={() => {window.location.href = "/user/login"}} className='h-[6vh] w-[90vw] bg-[#000] text-white poppins-medium rounded-md cursor-pointer relative hover:bg-[#222] transition-all duration-200'>Continue
